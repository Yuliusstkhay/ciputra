            ...
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                <form id="frm-jadwalkuliah" class="needs-validation" novalidate>
                    ...
                    <div class="form-group mb-5">
                        <div class="col-12">
                            <a href="{{url('jadwalkuliah/jadwalkuliah/'.$programStudi->bidang_studi_id."_".$programStudi->fakultas->fakultas_id)}}" class="btn btn-dark float-start col-lg-2 col-md-2 col-sm-4 d-none d-lg-block d-md-block d-print-block">Kembali</a>
