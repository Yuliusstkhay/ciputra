    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('jadwalkuliah/programstudi/'.$fakultas)}}">Program Studi</a></li>
                ...
                <div class="bgc-white bd bdrs-3 p-20 mB-20">
                    <div class="page-header d-print-none mB-20">
                        <div class="row align-items-center">
                            ...
                            <!-- Page title actions -->
                            @if(checkHakAkses(["M08.02"]))
                            <div class="col-auto ms-auto">
                                <div class="btn-list">
                                    <a href="{{route('jadwalkuliah.create',$id)}}" class="btn btn-info">
