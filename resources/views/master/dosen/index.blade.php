...
<link href="{{asset('DataTables/datatables.min.css')}}" rel="stylesheet">
    ...
    <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{url('dosen/programstudi/'.$fakultas)}}">Program Studi</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="bgc-white bd bdrs-3 p-20 mB-20">
                    <div class="page-header d-print-none mB-20">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto ms-auto d-print-none">
                                <div class="btn-list">
                                    <a href="{{route('dosen.create',$id)}}" class="btn btn-info d-none d-sm-inline-block">
                    ...
                    <table id="tbl-dosen" class="table table-hover" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama</th>
    ...
    <script type="text/javascript">
        var list = '{{route("dosen.list",$id)}}';
        var nonaktif = '{{url("dosen/void")}}';
        var aktif = '{{url("dosen/unvoid")}}';
    </script>
