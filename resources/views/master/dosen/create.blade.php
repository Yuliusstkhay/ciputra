...
<div class="container-fluid">
    <h4 class="c-grey-900 mT-10 mB-30">Tambah Dosen</h4>
    <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('dosen')}}">Fakultas</a></li>
                <li class="breadcrumb-item"><a href="{{url('dosen/programstudi/'.$programStudi->fakultas->fakultas_id)}}">Program Studi</a></li>
                <li class="breadcrumb-item"><a href="{{url('dosen/dosen/'.$programStudi->bidang_studi_id."_".$programStudi->fakultas->fakultas_id)}}">Master Dosen</a></li>
            ...
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                <form id="frm-dosen" class="needs-validation" novalidate>
                    ...
                    <div class="form-group mb-5">
                        <div class="col-12">
                            <a href="{{url('dosen/dosen/'.$programStudi->bidang_studi_id."_".$programStudi->fakultas->fakultas_id)}}" class="btn btn-dark float-start col-lg-2 col-md-2 col-sm-4 d-none d-lg-block d-md-block d-print-block">Kembali</a>
...
<script type="text/javascript">
    var store = '{{route("dosen.store")}}';
    var urlx = '{{url("dosen/dosen/".$programStudi->bidang_studi_id."_".$programStudi->fakultas->fakultas_id)}}';
    var hakakses = '{{route("dosen.hakakses")}}';
</script>
<script type="text/javascript" src="{{asset('js/dosen/store.js')}}"></script>
@stop
