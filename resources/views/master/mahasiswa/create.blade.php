            ...
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                <form id="frm-programstudi" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nip" name="nip" placeholder="NIM" required>
                    ...
                    <div class="form-group mb-5">
                        <div class="col-12">
                            <a href="{{url('mahasiswa/mahasiswa/'.$programStudi->bidang_studi_id."_".$programStudi->fakultas->fakultas_id)}}" class="btn btn-dark float-start col-lg-2 col-md-2 col-sm-4 d-none d-lg-block d-md-block d-print-block">Kembali</a>
