        ...
        <div class="col-md-12 col-sm-12">
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                    ...
                    <div class="form-group mb-5">
                        <div class="col-12">
                            <a href="{{url('mahasiswa/mahasiswa/'.$data->programStudi->bidang_studi_id."_".$data->programStudi->fakultas->fakultas_id)}}" class="btn btn-dark float-start col-lg-2 col-md-2 col-sm-4 d-none d-lg-block d-md-block d-print-block">Kembali</a>
                            <a href="{{url('mahasiswa/getDataUpdate/'.$data->id)}}" class="btn btn-primary float-end col-lg-2 col-md-2 col-sm-4">Ubah Data</a>
                        </div>
                    </div>
            </div>
        </div>
