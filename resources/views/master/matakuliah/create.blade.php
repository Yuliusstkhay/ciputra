        ...
        <div class="col-md-10 col-sm-12">
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                <form id="frm-programstudi" class="needs-validation" novalidate>
                    {{csrf_field()}}
                    <input type="hidden" name="fakultas_id" id="fakultas_id" value="{{$programStudi->fakultas_id}}" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="mata_kuliah_name" name="mata_kuliah_name" placeholder="Mata Kuliah" required>
                    ...
                    <div class="form-group mb-5">
                        <div class="col-12">
                            <a href="{{url('matakuliah/matkul/'.$programStudi->bidang_studi_id."_".$programStudi->fakultas_id)}}" class="btn btn-dark float-start col-lg-2 col-md-2 col-sm-4 d-none d-lg-block d-md-block d-print-block">Kembali</a>
