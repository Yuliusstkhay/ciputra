            ...
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
                <form id="frm-fakultas" class="needs-validation" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="fakultas_name" name="fakultas_name" placeholder="Fakultas" required>
...
var store = '{{route("fakultas.store")}}';
var urlx = '{{route("fakultas")}}';
</script>
<script type="text/javascript" src="{{asset('js/fakultas/store.js')}}"></script>
@stop