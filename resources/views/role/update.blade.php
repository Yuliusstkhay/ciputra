                                    ...
                                    <div class="row">
                                        <div class="col-md-5 col-lg-5 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="role_name" name="role_name" placeholder="Hak Akses" value="{{$data->role_name}}" required>
                                        ...
                                        <div class="col-md-7 col-lg-7 col-sm-12">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="1" id="check-admin" {{($data->is_admin==1)?"checked":""}}>
                                                <label class="form-check-label text-dark" for="check-admin">
                                                    Tampilkan pada admin
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="" id="check-dosen" {{($data->is_dosen==1)?"checked":""}}>
                                                <label class="form-check-label text-dark" for="check-dosen">
                                                    Tampilkan pada dosen
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="1" id="check-mahasiswa" {{($data->is_mahasiswa==1)?"checked":""}}>
