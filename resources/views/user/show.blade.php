                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="user_id" name="user_id" placeholder="Email" value="{{$data->user_id}}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="notes" id="notes" rows="6" disabled="">{!! $data->notes !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="user_id" name="user_id" placeholder="Email" value="{{$data->role->role_name}}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" id="modul">
                                        @foreach($data->userAccess as $key => $row)
