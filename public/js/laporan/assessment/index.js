...
function datatable(){
    ...
    var table = $('#tbl-laporandetail').DataTable({
        ...
        columns: [{
            ...
            {
                data: 'penilaian_assessment.assessment.assessment_name',
                name: 'penilaian_assessment.assessment.assessment_name'
            },
            {
                data: 'item_penilaian',
                name: 'item_penilaian'
            ...
            {
                data: 'dosen_mahasiswa.name',
                name: 'dosen_mahasiswa.name'
            },
            {
                data: 'nilai',
                name: 'nilai'
