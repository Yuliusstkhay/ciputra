...
//        dd($request->all());
    ...
    public function getItemDelete($item, $penilaianAssessment, $key) {
        $action = '<div class="row"><button type="button" class="btn btn-danger ml-3 col-lg-3 col-md-3 col-sm-3 mb-3" disabled><i class="far fa-trash-alt"></i></button></div>';
//        $action = '<div class="row">&nbsp;</button></div>';
        return $action;
    }

    public function addKriteria($penilaianAssessment) {
        $action = '<button type="button" class="btn btn-info btnItem mb-3" title="Tambah Item" data-value="' . $penilaianAssessment . '">
